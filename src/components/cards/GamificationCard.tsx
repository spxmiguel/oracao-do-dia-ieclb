    ...
    <Card className="space-y-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm opacity-70">Ganhe XP ao respirar, concluir a manhã e fechar a noite.</p>
        </div>
        <div className="rounded-2xl bg-white/60 px-3 py-2 text-right dark:bg-white/8">
      ...
      <div className="grid grid-cols-3 gap-2 text-center text-xs font-bold">
        <span className="rounded-2xl bg-white/55 p-3 dark:bg-white/8">Respirar +10</span>
        <span className="rounded-2xl bg-white/55 p-3 dark:bg-white/8">Manhã +40</span>
        <span className="rounded-2xl bg-white/55 p-3 dark:bg-white/8">Noite +50</span>
      </div>
      ...
      <div>
        ...
        <div className="h-3 overflow-hidden rounded-full bg-black/5 dark:bg-white/10">
          <motion.div
            ...
            className="h-full rounded-full bg-morning-accent dark:bg-night-accent"
            initial={{ width: 0 }}
        ...
        {progress.achievements.map((achievement) => (
          <div
            ...
            className={`flex items-center gap-3 rounded-2xl p-3 transition ${
              achievement.unlocked ? "bg-morning-accent/16 dark:bg-night-accent/18" : "bg-white/45 opacity-55 dark:bg-white/6"
            }`}
          >
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/70 dark:bg-white/10">

...
export function DaySummaryCard({ streak, onOpenJournal }: DaySummaryCardProps) {
  return (
    <Card className="space-y-5 text-center">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-morning-accent/20 night:bg-night-accent/20">
        <Flame className="h-7 w-7 text-morning-accent night:text-night-accent" />
      </div>
      <div>
      ...
      <p className="rounded-2xl bg-white/60 p-3 text-sm font-bold night:bg-white/8">{streak} dia(s) de constância</p>

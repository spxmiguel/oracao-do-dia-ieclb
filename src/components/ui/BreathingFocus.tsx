...
export function BreathingFocus({ onComplete }: BreathingFocusProps) {
  ...
  return (
    <div className="flex min-h-[64vh] flex-col items-center justify-center text-center">
      <motion.div
        className="mb-8 h-44 w-44 rounded-full bg-morning-accent/25 ring-1 ring-morning-accent/30 dark:bg-night-accent/20 dark:ring-night-accent/30"
      ...
      <div className="mt-8 h-1.5 w-56 overflow-hidden rounded-full bg-black/10 dark:bg-white/10">
        <div className="h-full rounded-full bg-morning-accent dark:bg-night-accent" style={{ width: `${progress}%` }} />
      </div>
